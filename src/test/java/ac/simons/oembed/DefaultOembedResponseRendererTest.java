...
public class DefaultOembedResponseRendererTest {
	...
	response.setHeight(100);
	    ...
	    Assertions.assertEquals("<img src=\"http://info.michael-simons.eu/wp-content/uploads/2015/05/Blogcake.jpeg\" style=\"width:200px; height:100px;\" alt=\"\" title=\"\"/>", renderer.render(response, null));
	response.setTitle("test");
	    Assertions.assertEquals("<img src=\"http://info.michael-simons.eu/wp-content/uploads/2015/05/Blogcake.jpeg\" style=\"width:200px; height:100px;\" alt=\"test\" title=\"test\"/>", renderer.render(response, null));
    }
	...
	Assertions.assertEquals("<html />", renderer.render(response, null));
    }
	...
	Assertions.assertEquals("<a href=\"http://info.michael-simons.eu\">http://info.michael-simons.eu</a>", renderer.render(response, originalAnchor));
	response.setTitle("title");
	response.setUrl("http://info.michael-simons.eu/2015/05/24/java20/");
	Assertions.assertEquals("<a href=\"http://info.michael-simons.eu/2015/05/24/java20/\">title</a>", renderer.render(response, originalAnchor));
    }
