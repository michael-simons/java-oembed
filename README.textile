...
public class OembedConfig {
	...
	final OembedService oembedService = new OembedService(httpClient, cacheManager, endpoints, "dailyfratze");	
...
# dailyfratze.oembed.autodiscovery =

# The name of the cached used by this service. Defaults to "de.dailyfratze.text.oembed.OembedService.OembedService".
# dailyfratze.oembed.cacheName

# Time in seconds responses are cached. Used if the response has no cache_age, defaults to 3600 (one hour).
# dailyfratze.oembed.defaultCacheAge =

dailyfratze.oembed.endpoints[0].name = youtube
dailyfratze.oembed.endpoints[0].endpoint = https://www.youtube.com/oembed
dailyfratze.oembed.endpoints[0].maxWidth = 480
dailyfratze.oembed.endpoints[0].urlSchemes[0] = https?://(www|de)\\.youtube\\.com/watch\\?v=.*
# dailyfratze.oembed.endpoints[0].responseRendererClass = de.dailyfratze.text.oembed.YoutubeRenderer
</code></pre>